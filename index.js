...
// Applies correct stylings
function correctStylings(forceMobile = false) {
    ...
    if (mobile) {
        ...
        if (!isFirefox) {
            ...
            document.body.style.setProperty("MozTransform", `scale(${zoom})`)
        }
